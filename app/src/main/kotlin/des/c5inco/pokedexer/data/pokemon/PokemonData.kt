...
val SamplePokemonData =
    listOf(
        Pokemon(
            ...
            specialDefense = 65,
            speed = 45,
            evolutionChain = listOf(Evolution(1, -1), Evolution(2, 16), Evolution(3, 32)),
        ),
        Pokemon(
            id = 2,
            name = "Ivysaur",
        ...
        Pokemon(
            ...
            specialDefense = 50,
            speed = 65,
            evolutionChain = listOf(Evolution(4, -1), Evolution(5, 16), Evolution(6, 32)),
        ),
        Pokemon(
            id = 5,
            name = "Charmeleon",
        ...
        Pokemon(
            ...
            specialDefense = 64,
            speed = 43,
            evolutionChain = listOf(Evolution(7, -1), Evolution(8, 16), Evolution(9, 32)),
        ),
        Pokemon(
            id = 8,
            name = "Wartortle",
        ...
        Pokemon(
            ...
            speed = 90,
            evolutionChain =
                listOf(Evolution(25, -1), Evolution(26, -1, EvolutionTrigger.UseItem, 83)),
        ),
        Pokemon(
            id = 26,
            name = "Raichu",
...
fun mapSampleEvolutionsToList(sample: List<Evolution>): List<PokemonDetailsEvolutions> {
    return sample.map {
...
fun mapSampleMovesToDetailsList(): List<PokemonDetailsMoves> {
    return SampleMoves.map { PokemonDetailsMoves(it, 0) }
}

fun mapSampleAbilitiesToDetailsList(): List<PokemonDetailsAbilities> {
    return SampleAbilities.map { PokemonDetailsAbilities(it, it.id % 2 == 0) }
}
