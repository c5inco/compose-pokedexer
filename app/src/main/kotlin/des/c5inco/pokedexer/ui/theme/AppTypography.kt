...
val AppTypography =
    Typography(
        displaySmall =
            TextStyle(fontWeight = FontWeight.Black, fontSize = 36.sp, fontFamily = appFontFamily),
        headlineMedium = TextStyle(fontWeight = FontWeight.Black, fontFamily = appFontFamily),
        headlineSmall =
            TextStyle(fontWeight = FontWeight.Black, fontSize = 30.sp, fontFamily = appFontFamily),
        titleLarge =
        ...
        titleMedium =
            TextStyle(fontWeight = FontWeight.Bold, fontSize = 16.sp, fontFamily = appFontFamily),
