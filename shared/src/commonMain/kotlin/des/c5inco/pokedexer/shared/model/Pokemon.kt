...
data class Pokemon(
    ...
    @ColumnInfo(name = "types") val typeOfPokemon: List<String> = listOf(),
    val category: String,
    val image: Int,
    ...
    @ColumnInfo(defaultValue = "1") val generationId: Int = 1,
    val hp: Int,
    val attack: Int,
    val defense: Int,
    ...
    @ColumnInfo(name = "moves", defaultValue = "") val movesList: List<PokemonMove> = listOf(),
